...
const DT = [
  ...
  {id:9,name:'KEBI-Kohinoor Exchange Board of India',color:'#FFD700',members:[{name:'Harshit Shah'},{name:'Nikesh Shah'},{name:'Rupesh Shah'},{name:'Kaushal Shah'},{name:'Pratik Shah'}]}
];
const DCR = [
  {id:'harshit_s',u:'harshit.s',p:'harkebi@1',role:'admin',co:'KEBI-Kohinoor Exchange Board of India',name:'Harshit Shah',pos:'KEBI Admin'},
  {id:'nikesh_s',u:'nikesh.s',p:'nikkebi@2',role:'admin',co:'KEBI-Kohinoor Exchange Board of India',name:'Nikesh Shah',pos:'KEBI Admin'},
  {id:'rupesh_s',u:'rupesh.s',p:'rupkebi@3',role:'admin',co:'KEBI-Kohinoor Exchange Board of India',name:'Rupesh Shah',pos:'KEBI Admin'},
  {id:'kaushal_s',u:'kaushal.s',p:'kaukebi@4',role:'admin',co:'KEBI-Kohinoor Exchange Board of India',name:'Kaushal Shah',pos:'KEBI Admin'},
  {id:'pratik_p',u:'pratik.p',p:'prakebi@5',role:'admin',co:'KEBI-Kohinoor Exchange Board of India',name:'Pratik Shah',pos:'KEBI Admin'},
...
app.post('/api/reject/:id',auth,adm,(req,res)=>{
  ...
  if(!sub)return res.status(404).json({error:'Not found'});
  sub.status='rejected';
  // Push rejection news to ALL users via server state
